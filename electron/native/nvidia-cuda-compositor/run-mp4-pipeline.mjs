...
const ffmpegCommand = resolveToolCommand(["GLASSCAST_FFMPEG_EXE"], "ffmpeg-static", "ffmpeg");
const ffprobeCommand = resolveToolCommand(["GLASSCAST_FFPROBE_EXE"], "ffprobe-static", "ffprobe");
...
function shouldRaiseChildPriority() {
	return process.env.GLASSCAST_NVIDIA_CUDA_EXPORT_HIGH_PRIORITY !== "0";
}
...
function resolveNativeProbePath() {
	const configuredPath = process.env.GLASSCAST_NVIDIA_CUDA_EXPORT_EXE;
