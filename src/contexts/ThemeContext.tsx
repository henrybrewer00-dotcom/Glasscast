...
const THEME_STORAGE_KEY = "glasscast.theme";
const LEGACY_THEME_STORAGE_KEY = legacyKeyFor(THEME_STORAGE_KEY) ?? "recordly.theme";
...
export function loadThemePreference(): ThemePreference {
	...
	try {
		const stored = readPersistedString(THEME_STORAGE_KEY);
