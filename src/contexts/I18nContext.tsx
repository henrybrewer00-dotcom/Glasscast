...
import { readPersistedString } from "@/lib/persistedKeyMigration";
...
const LOCALE_STORAGE_KEY = "glasscast.locale";
...
function getInitialLocale(): AppLocale {
	...
	const storedLocale = readPersistedString(LOCALE_STORAGE_KEY);
	if (storedLocale) {
