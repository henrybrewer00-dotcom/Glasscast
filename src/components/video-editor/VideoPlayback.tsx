	...
	(
		...
		useEffect(() => {
			...
			const ticker = () => {
				...
				const activeZoomStyle: ZoomStyle = region?.style ?? "flat";
				const activeZoomIntensity: number | undefined = region?.intensity;
				...
				{pixiReady && videoReady && (
					...
					>
						<div
							...
							className="absolute rounded-md border border-[var(--brand-accent)]/80 bg-[var(--brand-accent)]/20 shadow-[0_0_0_1px_rgba(var(--brand-accent-rgb),0.35)]"
