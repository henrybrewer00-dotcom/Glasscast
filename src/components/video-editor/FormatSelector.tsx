				...
				return (
					<button
						...
						className={cn(
							...
							"focus:outline-none focus:ring-2 focus:ring-[var(--brand-accent)]/50 focus:ring-offset-2 focus:ring-offset-editor-dialog",
							isSelected
								? "bg-[var(--brand-accent)]/10 border-[var(--brand-accent)]/50 text-[var(--brand-accent)] dark:text-white"
					...
					>
						<div
							className={cn(
								...
								isSelected ? "bg-[var(--brand-accent)]/20 text-[var(--brand-accent)]" : "bg-foreground/5",
							)}
						>
							{option.icon}
						</div>
						...
						{isSelected && (
							<div className="absolute top-2 right-2 w-2 h-2 rounded-full bg-[var(--brand-accent)]" />
						)}
					</button>
				);
			})}
