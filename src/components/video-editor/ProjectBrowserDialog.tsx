...
export default function ProjectBrowserDialog({
	...
	// entries can be undefined while the project library is still loading or
	// when listing failed — never crash the whole editor over it.
									...
									>
										<div className="relative aspect-[16/10] w-full overflow-hidden rounded-[5px] bg-editor-dialog-alt shadow-[0_10px_18px_rgba(0,0,0,0.28)] transition duration-200 group-hover:-translate-y-0.5 group-hover:shadow-[0_16px_30px_rgba(0,0,0,0.38)]">
											{thumbnailSrc ? (
												...
												<div className="flex h-full w-full items-center justify-center bg-[hsl(240_5%_4%)] text-[10px] font-medium text-white/60">
													No preview yet
												</div>
											)}
											{entry.isCurrent ? (
												<div className="absolute right-1.5 top-1.5">
													<span className="rounded-[5px] bg-[var(--brand-accent)] px-1.5 py-0.5 text-[8px] font-semibold uppercase tracking-[0.14em] text-white shadow-[0_8px_20px_rgba(var(--brand-accent-rgb),0.28)]">
														Current
													</span>
												</div>
											) : null}
	...
	return (
		<div className="pointer-events-none fixed inset-0 z-[90]">
			<div
				...
				className="pointer-events-auto fixed w-[min(280px,calc(100vw-24px))] overflow-hidden rounded-lg border border-border bg-editor-surface text-foreground shadow-xl animate-in fade-in-0 duration-150"
			>
				<div className="border-b border-foreground/10 px-3 py-2.5">
					<div className="text-sm font-medium tracking-tight text-foreground">Projects</div>
				</div>
