...
describe("timeline source audio tracks", () => {
	it("builds candidates for Windows and macOS sidecar containers", () => {
		expect(buildSourceSidecarPathCandidates("C:\\Glasscast\\recording-1.mp4", "mic")).toEqual([
			"C:/Glasscast/recording-1.mic.wav",
			"C:/Glasscast/recording-1.mic.m4a",
			"C:/Glasscast/recording-1.mic.webm",
		]);
	});
