	...
	return (
		...
		>
			<div className="relative h-full min-h-0">
				...
				<div
					ref={tooltipRef}
					className="absolute top-1 pointer-events-none z-[60] px-1.5 py-0.5 rounded-md bg-[#1a1a1e] text-[10px] text-[#f5f5f6] tabular-nums whitespace-nowrap border border-[#26262b] shadow-lg"
					style={{ opacity: 0, transition: "opacity 0.15s ease-out", fontFamily: TIMELINE_MONO_FONT }}
				/>
			</div>
		</TimelineContext>
	);
