...
export function ExportSettingsMenu({
	...
	return (
		<div
			className={cn(
				"w-full rounded-lg border border-border bg-editor-surface p-3 text-foreground",
				className,
			)}
		>
						...
						return (
							<button
								...
								className={cn(
									...
									isActive
										? "border-[var(--brand-accent)]/50 text-[var(--brand-accent)] dark:text-white"
			...
			{exportFormat === "mp4" ? (
				<LayoutGroup id="header-export-quality-toggle">
					...
					{!isLegacyModel && nvidiaCudaExportAvailable ? (
						<div className="mb-3 flex min-h-12 items-center justify-between gap-3 rounded-lg border border-[var(--brand-accent)]/20 bg-[var(--brand-accent)]/5 px-3 py-2">
							<div className="min-w-0">
								<div className="flex items-center gap-1.5">
									<span className="text-[11px] font-semibold text-foreground">
										{tSettings("export.nvidiaCuda.title", "NVIDIA CUDA")}
									</span>
									<span className="rounded bg-[var(--brand-accent)]/10 px-1.5 py-0.5 text-[9px] font-semibold uppercase text-[var(--brand-accent)]">
							...
							<Switch
								...
								className="shrink-0 scale-75 data-[state=checked]:bg-[var(--brand-accent)]"
							/>
						</div>
					) : null}
				</LayoutGroup>
					...
					<div className="flex items-center justify-between px-1">
						...
						<div className="flex items-center gap-2">
							...
							<Switch
								...
								className="scale-75 data-[state=checked]:bg-[var(--brand-accent)]"
							/>
						</div>
					</div>
				</div>
			...
			<Button
				...
				size="lg"
				onClick={onExport}
				className="h-11 w-full gap-2 rounded-lg bg-[var(--brand-accent)] text-sm font-semibold text-white transition-colors duration-200 hover:bg-[var(--brand-accent)]/90"
			>
