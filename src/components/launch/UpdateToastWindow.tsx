...
export function UpdateToastWindow() {
	...
	const iconBoxStyle = {
		...
		color: "#60a5fa",
		boxShadow: "inset 0 0 0 1px rgba(var(--brand-accent-rgb), 0.18)",
	} as const;
	const titleStyle = {
		fontSize: 15,
		fontWeight: 700,
	...
	const primaryButtonStyle = {
		...subtleButtonStyle,
		border: "none",
		background: "linear-gradient(180deg, #3b82f6 0%, var(--brand-accent) 100%)",
		color: "#ffffff",
		boxShadow: "0 12px 24px rgba(var(--brand-accent-rgb), 0.26)",
	} as const;
	const selectStyle = {
		height: 38,
		borderRadius: 12,
		...
		fontWeight: 600,
		outline: "none",
		boxShadow: "inset 0 0 0 1px rgba(var(--brand-accent-rgb), 0.06)",
		cursor: "pointer",
	} as const;
							...
							>
								<div
									style={{
										...
										borderRadius: 999,
										background:
											"linear-gradient(90deg, #60a5fa 0%, var(--brand-accent) 45%, #1d4ed8 100%)",
										boxShadow: "0 0 22px rgba(var(--brand-accent-rgb), 0.38)",
									}}
								/>
							</div>
							<div
