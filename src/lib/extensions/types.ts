/**
 * Glasscast Extension System — Core Types
 *
...
export interface ExtensionManifest {
	...
	license?: string;
	/** Minimum Glasscast version required */
	engine?: string;
 ...
 *
 * Glasscast does not auto-register these entries at runtime today.
...
export interface GlasscastExtensionAPI {
...
export interface GlasscastExtensionModule {
	/** Called when the extension is activated */
	activate(api: GlasscastExtensionAPI): void | Promise<void>;
